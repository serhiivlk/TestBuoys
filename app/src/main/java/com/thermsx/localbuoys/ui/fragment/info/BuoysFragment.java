...
import com.thermsx.localbuoys.databinding.FragmentBuoysBinding;
...
public class BuoysFragment extends InfoFragment {
    private FragmentBuoysBinding mBinding;

    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        mBinding = DataBindingUtil.inflate(inflater, R.layout.fragment_buoys, container, false);
